...
const DepartmentsSection = (vm: Example4NestedVM): Child =>
  List(vm.form.fields.departments.$items, (dept, deptIndex) =>
    DepartmentCard({
      dept,
      deptIndex,
      appendEmployee: vm.arrayActions.appendEmployee,
      removeDept: vm.arrayActions.removeDept,
      appendTicket: vm.arrayActions.appendTicket,
      removeEmployee: vm.arrayActions.removeEmployee,
      removeTicket: vm.arrayActions.removeTicket,
