...
title: Feature First
description:
  Organize EchoJS code by user-facing features with clear public APIs.
keywords: [feature-first, fsd, folders, structure]
---

# Feature First

**Feature-first** means the primary unit of organization is a **user
capability** (“search docs”, “toggle theme”, “run query demo”), not a technical
type (`components/`, `hooks/`, `utils/` at the repo root).

## What counts as a feature

A feature folder answers: _what can the user do here?_
...
> [!WARNING] Deep imports (`@features/query-demo/model/...`) bypass the feature
> boundary and make refactors painful.
...
`widgets/code-block` has its own model (Shiki, copy) because it is reused on
home and doc pages. That is fine: **widget ≈ feature shared across routes**.
