...
description: createModel, createView, createComponent, Show, and List in the example app.
package: "@echojs-ecosystem/hyperdom"
---

# Model + View Counter

EchoJS convention: signals in the model, presentation in the view, `createComponent` for the route.

## Problem

Structure a feature with reusable model/view boundaries and compose `Show` + `List` in the view.
...
```ts
import { createView, Show, List, article, span, p } from "@echojs-ecosystem/hyperdom";
