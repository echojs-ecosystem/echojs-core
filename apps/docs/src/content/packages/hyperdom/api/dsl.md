...
Each DSL export mirrors `h()` with **typed props** for that intrinsic element. Imported from the main package entry.

```ts
import {
  div, button, span, section, article, nav,
  h1, h2, h3, p, form, input, textarea, select,
  ul, ol, li, table, img, svg,
  // ...
