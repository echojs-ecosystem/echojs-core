...
description: How Echo packages register with devtools and planned overlay wiring.
package: "@echojs-ecosystem/devtools"
---

# Package Integration

Echo ecosystem packages integrate with devtools **automatically** when enabled — you rarely call registry APIs directly.
