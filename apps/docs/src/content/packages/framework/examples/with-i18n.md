...
Custom provider using `createProvider` — typed install, auto-provide, and root wrapper.
...
import { i18nProvider, queryProvider, routerProvider, themeProvider, uiProvider } from "./providers/index.js";
...
Register i18n **before** router when route views read translated strings during first navigation.
