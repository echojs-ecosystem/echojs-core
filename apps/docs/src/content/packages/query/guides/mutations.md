---
title: Mutations
description: createMutation — optimistic updates, rollback, and running mutations from models.
package: "@echojs-ecosystem/query"
---

# Mutations

**Mutations** handle write operations — POST, PUT, DELETE — with lifecycle hooks and optional optimistic cache updates.
...
- [QueryClient & Cache](/docs/packages/query/guides/query-client)
- [API: createMutation](/docs/packages/query/api/create-mutation)
