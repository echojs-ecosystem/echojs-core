...
title: Installation
description:
  Install @echojs-ecosystem/query and register createQueryProvider in your
  EchoJS app.
...
`@echojs-ecosystem/query` is framework-agnostic at the core; EchoJS apps
...
import {
  createQuery,
  createQueryProvider,
} from '@echojs-ecosystem/framework/query'
```
...
- [Query Definitions](/docs/packages/query/guides/query-definitions) — first
  patterns
- [Reactive Binding](/docs/packages/query/guides/reactive-binding) — `.with()`
  in models
