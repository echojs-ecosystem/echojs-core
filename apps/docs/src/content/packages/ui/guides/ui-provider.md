...
Register a UI provider in `createEchoApp` to supply global theme, default
variants, and component overrides.
...
The provider can wrap the app root so all views inherit theme context and
default variants without per-component setup.
