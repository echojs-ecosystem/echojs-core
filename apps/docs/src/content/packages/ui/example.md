...
title: Examples
description:
  UIProvider, Button, and form row patterns from packages/ui and apps/example.
package: '@echojs-ecosystem/ui'
---

# Examples

Working fragments from `packages/ui` and `apps/example`. Full component coverage
is **expanding** — see Storybook for the latest catalog.
