---
title: Parsers
description: parseAs* built-ins, withDefault, custom parsers, and serialization rules.
package: "@echojs-ecosystem/url-state"
---

# Parsers

Parsers define how a query param string maps to a typed value and back. Every param or schema field uses a parser.
...
const parseAsStars = createCustomParser({
  parse: (value) => { /* string | string[] | null → number */ },
