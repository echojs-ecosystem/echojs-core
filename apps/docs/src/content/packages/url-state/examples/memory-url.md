...
The memory adapter simulates URL search params in a string — no browser or
router required. Ideal for unit tests and SSR-less logic verification.

## Problem

Test param parsing, serialization, and set/update logic without `window` or a
full router setup.
