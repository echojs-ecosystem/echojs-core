...
Persist wraps snapshots in a versioned record envelope before writing to storage.
...
Pass a custom `serializer` in `PersistOptions` when you need compression or encryption.
