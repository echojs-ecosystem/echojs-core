...
description:
  How persist attaches to stores, the controller API, and record format.
package: '@echojs-ecosystem/persist'
---

# Important Defaults

`@echojs-ecosystem/persist` extends Echo stores at runtime. These defaults shape
hydration timing, auto-save behavior, and how snapshots are stored.
...
`persistField` / `persistFieldArray` are aliases for form-like targets (future
