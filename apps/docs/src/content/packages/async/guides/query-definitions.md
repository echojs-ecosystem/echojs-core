...
description:
  createQuery — queryKey, queryFn, cache options, and where definitions live.
package: '@echojs-ecosystem/async'
---

# Query Definitions

A **query definition** describes how to load, cache, and invalidate a resource.
Definitions are created once at module scope; models bind them to reactive
params with `.with()`.
...
- [Reactive Binding](/docs/packages/async/guides/reactive-binding)
- [API: createQuery](/docs/packages/async/api/create-query)
- [Examples: JSONPlaceholder](/docs/packages/async/examples/jsonplaceholder)
