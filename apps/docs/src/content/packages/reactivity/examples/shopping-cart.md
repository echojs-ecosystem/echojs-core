...
title: Shopping Cart
description:
  Line items in a signal with computed totals and immutable quantity updates.
package: '@echojs-ecosystem/reactivity'
---

# Shopping Cart

Cart state is an **array of line objects** in a signal. Totals and item counts
are **`computed`** — the UI always reflects current lines without manual
recalculation.

## Problem

Add items, change quantities, remove zero-qty lines, and show live **total
