...
export const blogPageStyles = tv({
  slots: {
    ...
    articleMeta: "mt-4 flex flex-wrap items-center gap-x-3 gap-y-2 text-sm text-fg-subtle",
    ...
    notFound: "rounded-2xl border border-border/80 bg-surface-elevated/50 p-8 text-center dark:border-white/10",
