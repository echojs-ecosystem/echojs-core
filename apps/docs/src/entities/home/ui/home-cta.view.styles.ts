...
export const homeCtaStyles = tv({
  slots: {
    ...
    ctaGrid:
      'relative grid gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,22rem)] lg:items-center lg:gap-10',
    ctaCopy: 'flex flex-col',
    ctaEyebrow:
      'text-xs font-semibold uppercase tracking-[0.2em] text-echo-700 dark:text-echo-400',
