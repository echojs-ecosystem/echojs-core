...
export const frameworkStrengthStyles = tv({
  slots: {
    root: 'relative overflow-hidden rounded-2xl border border-border/80 bg-surface-elevated p-6 shadow-lg shadow-black/5 sm:p-8 dark:border-white/10 dark:bg-surface-elevated/40 dark:shadow-black/25',
