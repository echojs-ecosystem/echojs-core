...
export const homeArchitectureStyles = tv({
  slots: {
    ...
    diagramInner:
      'relative z-10 mx-auto flex max-w-sm flex-col items-center gap-2',
    diagramCaption:
    ...
    advantageTitle:
      'mt-3 text-base font-semibold text-fg group-hover:text-echo-800 dark:group-hover:text-echo-100',
