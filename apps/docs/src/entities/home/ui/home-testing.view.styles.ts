...
export const homeTestingStyles = tv({
  slots: {
    ...
    advantageTitle: "text-sm font-semibold leading-snug text-fg group-hover:text-echo-800 dark:group-hover:text-echo-100",
    ...
    pipelineHint: "mt-1 text-[10px] font-medium uppercase tracking-wider text-fg-subtle",
    ...
    editorBody: "p-0 [&_.group]:my-0 [&_.group]:rounded-none [&_.group]:border-0",
    editorFoot:
