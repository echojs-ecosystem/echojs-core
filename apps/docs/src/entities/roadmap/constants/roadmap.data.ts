...
export const roadmapColumns: RoadmapColumn[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          'Inspect signals, queries, and router state in the running app.',
        tags: ['devtools'],
      },
      {
        id: 'ssr',
        title: 'SSR / SSG',
        description:
          'Server rendering and static generation for docs and product sites.',
        tags: ['framework'],
      },
      {
        id: 'stories',
        ...
        description:
          'Storybook-style playground for UI primitives and patterns.',
        tags: ['ui', 'dx'],
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          'Deeper integration between @echojs-ecosystem/form and UI inputs.',
        tags: ['form'],
      },
    ],
  },
    ...
    items: [
      {
        ...
        title: 'Core packages',
        description:
          'Reactivity, HyperDOM, framework, router, store, query, url-state, persist, i18n.',
        tags: ['core'],
      },
      {
        id: 'form-package',
        title: 'Form package',
        description:
          'createField, createForm, bindField, and Standard Schema validation.',
        tags: ['form'],
      },
      {
        id: 'docs-site',
        ...
        description:
          'Guides, package references, comparisons, and live playgrounds.',
        tags: ['docs'],
      },
      {
        id: 'architect',
        ...
        description:
          'Layer rules and import boundaries for monorepos and apps.',
        tags: ['tooling'],
      },
    ],
  },
