...
import { div, h3, p, span } from "@echojs-ecosystem/framework/hyperdom";
import { ideaCategoryOptions } from "@entities/roadmap/constants/roadmap.data.js";
import type { CommunityIdea, RoadmapColumn, RoadmapItem } from "@entities/roadmap/types/roadmap.types.js";
...
const RoadmapColumnView = (column: RoadmapColumn, extraItems: RoadmapItem[] = []): Child => {
...
export const RoadmapBoard = ({ columns, communityIdeas = [] }: RoadmapBoardProps): Child => {
