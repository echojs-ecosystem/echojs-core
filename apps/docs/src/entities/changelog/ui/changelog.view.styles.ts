...
export const changelogPageStyles = tv({
  slots: {
    ...
    section: 'space-y-3 pt-2',
    sectionTitle: 'text-lg font-semibold text-fg',
    sectionList: 'list-disc space-y-2 pl-5',
    packagesLabel: 'pt-4 text-sm font-semibold text-fg',
    packagesRow: 'mt-2 flex flex-wrap gap-1.5',
    packageTag:
      'rounded-md bg-surface-muted/70 px-1.5 py-0.5 font-mono text-xs text-fg-subtle dark:bg-surface-muted/40',
    backLink: [
...
export const changelogCardStyles = tv({
  slots: {
    card: [
  ...
  variants: {
    tone: {
      release: { version: 'text-emerald-700 dark:text-emerald-300' },
      initial: { version: 'text-sky-700 dark:text-sky-300' },
    },
  },
})
