...
export const frameworkComparisonStyles = tv({
  slots: {
    ...
    tableWrap:
      'mt-6 overflow-x-auto rounded-2xl border border-border/80 dark:border-white/10',
    ...
    gridFrameworkHead:
      'text-center text-[11px] font-semibold uppercase tracking-wider text-fg-subtle',
    ...
    cellNo:
      'inline-flex h-7 w-7 items-center justify-center text-sm text-fg-subtle',
    ...
    reasons:
      'mt-8 grid grid-cols-1 gap-3 min-[480px]:grid-cols-2 sm:gap-4 lg:grid-cols-4',
    reasonCard: [
    ...
    reasonIcon:
      'text-sm font-bold leading-none text-echo-700 dark:text-echo-300',
    ...
    deepDiveCardSoonBadge:
      'shrink-0 rounded-md bg-surface-muted px-2 py-0.5 text-[10px] font-medium uppercase',
  },
})
