...
export const ecosystemFeaturedPackageStyles = tv({
  slots: {
    ...
    glow:
      "pointer-events-none absolute -right-16 -top-16 h-48 w-48 rounded-full bg-echo-400/15 blur-3xl transition group-hover:bg-echo-400/25 dark:bg-echo-500/10",
    inner: [
    ...
    label: "text-[11px] font-semibold uppercase tracking-[0.14em] text-echo-800 dark:text-echo-300",
