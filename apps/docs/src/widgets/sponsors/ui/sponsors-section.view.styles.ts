...
export const sponsorsSectionStyles = tv({
  slots: {
    ...
    header: 'max-w-xl',
    eyebrow:
      'mb-3 text-xs font-semibold uppercase tracking-[0.2em] text-echo-700 dark:text-echo-400',
    ...
    actions:
      'mt-10 flex flex-wrap items-center justify-center gap-4 sm:justify-start',
    becomeBtn:
