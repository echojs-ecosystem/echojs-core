...
export type PackageCodeExample = { title: string; language: string; code: string };
...
export const packageOverviewById: Record<string, PackageOverviewData> = {
  reactivity: {
    ...
    whySubtitle: "Fine-grained state is not the same problem as server cache or global stores.",
    whyCards: [
      {
        icon: "◎",
    ...
    lifecycleSteps: [
      { step: "1", title: "Write", body: "signal.set / update changes a cell synchronously." },
      { step: "2", title: "Track", body: "computed and effect subscribers collect dependencies on .value() reads." },
      { step: "3", title: "Batch", body: "batch() coalesces multiple writes before notifications flush." },
      { step: "4", title: "Notify", body: "Effects and HyperDOM reactive nodes run once with fresh values." },
    ],
    codeExample: {
...
count.set(1);`,
    ...
    learnPath: [
      step("reactivity", "installation", "Installation", "Add the package to your app."),
      step("reactivity", "guides/important-defaults", "Important Defaults", "Execution model and conventions."),
      step("reactivity", "guides/signals", "Signals", "Writable cells and subscriptions."),
      step("reactivity", "examples/counter", "Counter", "Minimal signal + view pattern."),
  ...
  hyperdom: {
    ...
    whySubtitle: "UI updates are not the same problem as a component diffing runtime.",
    whyCards: [
      { icon: "→", title: "Direct DOM by default", body: "h() and DSL tags create real nodes. Reactive regions patch only what changed." },
      { icon: "◇", title: "Views with guardrails", body: "createView + strict context catch h() outside render scope early in dev." },
      { icon: "↻", title: "Reactive children & props", body: "() => child and getter props register effects from @echojs-ecosystem/reactivity." },
      { icon: "▣", title: "Model/view at the edge", body: "createModel for state, createComponent to glue page-level UI." },
    ],
    lifecycleTitle: "Render lifecycle",
    lifecycleSubtitle: "From view tree to mounted DOM and back.",
    lifecycleSteps: [
      { step: "1", title: "Build", body: "createView / h / DSL produce a Child tree." },
      { step: "2", title: "Mount", body: "render(view, container) activates bindings." },
      { step: "3", title: "Update", body: "Signal change → effect re-runs reactive nodes only." },
      { step: "4", title: "Teardown", body: "dispose() clears listeners, effects, and DOM." },
    ],
    codeExample: {
      title: "Just a quick look…",
      language: "ts",
...
render(
  ...
  document.getElementById("app")!,
    ...
    powers: ["ui", "router"],
    learnPath: [
      step("hyperdom", "installation", "Installation", "Add HyperDOM + reactivity."),
      step("hyperdom", "guides/important-defaults", "Important Defaults", "Strict context & conventions."),
      step("hyperdom", "guides/views-and-dsl", "Views & DSL", "h() and tag helpers."),
  ...
  framework: {
    ...
    whyCards: [
      { icon: "⊕", title: "Single entry", body: "Install once, import @echojs-ecosystem/framework/app and subpaths you need." },
      { icon: "⚙", title: "Providers wired", body: "Router, query, i18n, UI plug in via .use() before mount." },
      { icon: "🔌", title: "DI built in", body: "provide/inject for app services without a separate container." },
      { icon: "📦", title: "Subpath map", body: "Each ecosystem package re-exported — bundler pulls only what you import." },
    ],
    lifecycleTitle: "App bootstrap",
    lifecycleSubtitle: "From createEchoApp to mounted root.",
    lifecycleSteps: [
      { step: "1", title: "Create", body: "createEchoApp({ strictContextChecks })." },
      { step: "2", title: "Use", body: "Register providers — query, i18n, router." },
      { step: "3", title: "Mount", body: "mount('#app') renders root view or router outlet." },
      { step: "4", title: "Run", body: "Subpath imports for features — reactivity, hyperdom, store…" },
    ],
    codeExample: {
      title: "Just a quick look…",
      language: "ts",
...
createEchoApp()
  ...
  .mount("#app");`,
    ...
    learnPath: [
      step("framework", "installation", "Installation", "Meta-package install."),
      step("framework", "guides/create-echo-app", "createEchoApp", "Bootstrap flow."),
      step("framework", "guides/subpath-imports", "Subpath Imports", "Import map."),
  ...
  router: {
    ...
    whyCards: [
      { icon: "🗂", title: "Typed route trees", body: "Layouts, nested pages, lazy chunks — all as data, not JSX routes." },
      { icon: "📡", title: "Signal-backed URL", body: "$path and $activePage are reactive — views update without a router hook." },
      { icon: "🔗", title: "NavLink", body: "SPA navigation with active styles and prefetch hooks." },
      { icon: "🛡", title: "Guards & beforeLoad", body: "Auth, redirects, and route data before the page renders." },
    ],
    lifecycleTitle: "Navigation lifecycle",
    lifecycleSubtitle: "Match URL → load data → render page.",
    lifecycleSteps: [
      { step: "1", title: "Match", body: "URL change → route tree resolves active page." },
      { step: "2", title: "Load", body: "beforeLoad runs; lazy routes fetch chunks." },
      { step: "3", title: "Render", body: "createRouteView mounts HyperDOM page." },
      { step: "4", title: "Navigate", body: "go() / NavLink update history + signals." },
    ],
    codeExample: {
      title: "Just a quick look…",
      language: "ts",
...
const router = createRouter({ routes, history: createBrowserHistory() });`,
  ...
  store: {
    ...
    whyCards: [
      { icon: "▢", title: "Named modules", body: "Theme, auth, session — one store per concern in entity/*." },
      { icon: "⚡", title: "Actions via extend", body: "withActions adds methods without breaking immutability." },
      { icon: "⊂", title: "Derived slices", body: "select and combine expose readonly views of store state." },
      { icon: "📣", title: "Events", body: "Subscribe to store changes for logging or cross-module reactions." },
    ],
    lifecycleTitle: "Store lifecycle",
    lifecycleSubtitle: "Create, mutate, derive, reset.",
    lifecycleSteps: [
      { step: "1", title: "Create", body: "createStore(initial) in entity module." },
      { step: "2", title: "Extend", body: "withActions, withReadonly, persist adapters." },
      { step: "3", title: "Read", body: "Views read .state() or derived selectors." },
      { step: "4", title: "Reset", body: "reset() or logout clears session stores." },
    ],
    codeExample: {
      title: "Just a quick look…",
      language: "ts",
...
export const themeStore = createStore({ mode: "light" as "light" | "dark" })
  .extend(withActions(({ set }) => ({
    ...
    learnPath: [
      ...
      step("store", "guides/creating-stores", "Creating Stores", "First store module."),
      step("store", "guides/actions", "Actions", "withActions pattern."),
      step("store", "examples/theme-and-counter", "Theme & Counter", "Live patterns."),
  ...
  query: {
    ...
    whyCards: [
      { icon: "📋", title: "Cache by queryKey", body: "Definitions in models; instances bind reactive params with .with()." },
      { icon: "↻", title: "Background refresh", body: "staleTime, refetch, and focus/online managers built in." },
      { icon: "✏", title: "Mutations", body: "Optimistic updates, invalidation, and error recovery." },
      { icon: "🚫", title: "Abort built in", body: "queryFn receives AbortSignal — no leaked fetches." },
    ],
    lifecycleTitle: "Query lifecycle",
    lifecycleSubtitle: "Define → bind → fetch → cache → invalidate.",
    lifecycleSteps: [
      { step: "1", title: "Define", body: "createQuery({ queryKey, queryFn }) in model." },
      { step: "2", title: "Bind", body: ".with(() => params) ties to signals." },
      { step: "3", title: "Fetch", body: "Status signals drive loading UI." },
      { step: "4", title: "Invalidate", body: "Mutations refresh affected keys." },
    ],
    codeExample: {
      title: "Just a quick look…",
      language: "ts",
...
const userQuery = createQuery({
  ...
  queryFn: ({ signal }) => fetch("/api/me", { signal }).then((r) => r.json()),
    ...
    learnPath: [
      ...
      step("query", "guides/query-definitions", "Query Definitions", "Keys & queryFn."),
      step("query", "guides/mutations", "Mutations", "Writes & invalidation."),
      step("query", "examples/query-demo-model", "Query Demo", "Example app model."),
  ...
  "url-state": {
    ...
    whySubtitle: "Filters and pagination belong in the URL — not in opaque client state.",
    whyCards: [
      { icon: "🔤", title: "Typed parsers", body: "parseAsString, parseAsInteger, arrays — defaults included." },
      { icon: "📎", title: "Param groups", body: "createQueryParams returns signal-friendly object of params." },
      { icon: "🧭", title: "Router adapter", body: "Sync with @echojs-ecosystem/router history." },
      { icon: "🔗", title: "Shareable links", body: "Copy URL → same catalog filters for every visitor." },
    ],
    lifecycleTitle: "URL sync lifecycle",
    lifecycleSubtitle: "Parse → bind → update history → re-parse.",
    lifecycleSteps: [
      { step: "1", title: "Parse", body: "Parsers read search string into typed values." },
      { step: "2", title: "Bind", body: "Signals hold current param state." },
      { step: "3", title: "Update", body: "User action → write params → push URL." },
      { step: "4", title: "Back/forward", body: "History events re-sync signals." },
    ],
    codeExample: {
      title: "Just a quick look…",
      language: "ts",
...
const params = createQueryParams({
  ...
  page: parseAsInteger.withDefault(1),
    ...
    learnPath: [
      ...
      step("url-state", "guides/query-params", "createQueryParams", "Param groups."),
      step("url-state", "examples/catalog-filters", "Catalog Filters", "Real pattern."),
  ...
  persist: {
    ...
    whyCards: [
      { icon: "💿", title: "Storage adapters", body: "localStorage, sessionStorage, cookies, IndexedDB." },
      { icon: "🔀", title: "Slice & merge", body: "Persist part of a store; merge on hydrate." },
      { icon: "📦", title: "Version & migrate", body: "Schema bumps with migrate() callbacks." },
      { icon: "🔐", title: "Logout flow", body: "clear() on session stores when auth ends." },
    ],
    lifecycleTitle: "Persist lifecycle",
    lifecycleSubtitle: "Hydrate → use → save → clear.",
    lifecycleSteps: [
      { step: "1", title: "Extend", body: "store.extend(withLocalStorage(...))." },
...
export const themeStore = createStore({ mode: "light" }).extend(
  withLocalStorage({ key: "theme", select: (s) => ({ mode: s.mode }) }),
    ...
    learnPath: [
      ...
      step("persist", "guides/storage-adapters", "Storage Adapters", "Pick adapter."),
      step("persist", "guides/hydrate-and-save", "Hydrate & Save", "Lifecycle."),
  ...
  i18n: {
    ...
    whyCards: [
      { icon: "🗣", title: "Typed keys", body: "JSON messages map to TypeScript key paths." },
      { icon: "🔄", title: "Lazy locales", body: "Load ru.json only when user switches locale." },
      { icon: "🌍", title: "Intl helpers", body: "formatNumber, formatDate, formatCurrency." },
      { icon: "↻", title: "Reactive t()", body: "Views re-render when locale or messages change." },
    ],
    lifecycleTitle: "Locale lifecycle",
    lifecycleSubtitle: "Load → translate → switch → format.",
    lifecycleSteps: [
      { step: "1", title: "Provider", body: "createI18nProvider at app bootstrap." },
      { step: "2", title: "t()", body: "Views call i18n.t('key') in reactive children." },
...
createEchoApp()
  ...
  .mount("#app");`,
    ...
    learnPath: [
      ...
      step("i18n", "guides/messages-and-keys", "Messages & Keys", "JSON structure."),
      step("i18n", "guides/locales", "Locales", "Lazy loading."),
      step("i18n", "examples/locale-switcher", "Locale Switcher", "en / ru demo."),
  ...
  ui: {
    ...
    whyCards: [
      { icon: "◈", title: "HyperDOM-native", body: "Components are createView factories — same reactivity model." },
      { icon: "🎨", title: "Theme tokens", body: "UIProvider + createTheme for light/dark." },
      { icon: "♿", title: "Accessibility", body: "ARIA patterns on Button, Field, Input." },
      { icon: "📦", title: "Granular imports", body: "@echojs-ecosystem/framework/ui/button for tree-shaking." },
    ],
    ...
    lifecycleSteps: [
      ...
      { step: "3", title: "Compose", body: "Field + Input + Button in features." },
      { step: "4", title: "Variants", body: "Props drive visual variants from theme." },
    ],
    codeExample: {
      title: "Just a quick look…",
      language: "ts",
...
// Wrap app with UIProvider, use Button in views`,
    ...
    learnPath: [
      ...
      step("ui", "guides/button-and-field", "Button & Field", "Core primitives."),
  ...
  devtools: {
    ...
    whySubtitle: "Fine-grained reactivity needs visible cache and dependency graphs.",
    whyCards: [
      { icon: "👁", title: "Registry API", body: "registerDevtoolsNode — packages emit structured debug nodes." },
      { icon: "📊", title: "Query cache", body: "Inspect keys, status, and observers (planned UI)." },
      { icon: "🧪", title: "Route match", body: "See guard chain and active route (planned UI)." },
    ...
    lifecycleSteps: [
      { step: "1", title: "Register", body: "Packages call registerDevtoolsNode in dev." },
      { step: "2", title: "Bridge", body: "Connect to browser extension or overlay." },
      { step: "3", title: "Timeline", body: "Events stream to DevTools panel." },
      { step: "4", title: "Strip", body: "Production build removes devtools imports." },
    ],
    codeExample: {
      title: "Just a quick look…",
      language: "ts",
...
registerDevtoolsNode({ id: "my-feature", type: "model", label: "Counter" });`,
    ...
    learnPath: [
      ...
      step("devtools", "guides/registry", "Registry & Timeline", "Runtime API."),
  ...
  cli: {
    ...
    whyCards: [
      { icon: "✨", title: "create", body: "Greenfield app with providers and example feature." },
      { icon: "⚙", title: "generate", body: "feature/, page/, widget/ stubs with index.ts." },
      { icon: "✓", title: "doctor", body: "Validate folder layout against architect rules." },
      { icon: "🏛", title: "Architect today", body: "Use @echojs-ecosystem/architect for lint until CLI ships." },
    ],
    lifecycleTitle: "CLI workflow (planned)",
    lifecycleSubtitle: "Create → generate → develop → doctor.",
    lifecycleSteps: [
      { step: "1", title: "create", body: "npx @echojs-ecosystem/cli create my-app" },
      { step: "2", title: "generate", body: "cli generate feature counter" },
      { step: "3", title: "dev", body: "bun dev with feature-first layout." },
      { step: "4", title: "doctor", body: "cli doctor — CI-friendly structure check." },
    ],
    codeExample: {
...
cd my-app && bun dev`,
    ...
    learnPath: [
      ...
      step("architect", "installation", "Architect", "Use echo-architect today."),
    ],
  ...
  architect: {
    ...
    whyCards: [
      { icon: "▦", title: "Layer graph", body: "app → pages → widgets → entities → shared — no upward imports." },
      { icon: "◉", title: "Public API", body: "Only import from slice index.ts — deep paths fail lint." },
      { icon: "✓", title: "CI integration", body: "echo-architect lint in GitHub Actions." },
      { icon: "🔧", title: "Presets", body: "feature-first preset matches docs and example apps." },
    ],
    lifecycleTitle: "Lint lifecycle",
    lifecycleSubtitle: "Configure → lint → fix → CI.",
    lifecycleSteps: [
      { step: "1", title: "Config", body: "architect.config.ts with layers preset." },
      { step: "2", title: "Lint", body: "echo-architect lint locally or in watch." },
      { step: "3", title: "Fix", body: "Move imports or add index.ts barrels." },
...
# or in package.json: "lint:arch": "echo-architect lint"`,
    ...
    learnPath: [
      ...
      step("architect", "guides/layers", "Layer Rules", "Dependency direction."),
      step("architect", "examples/docs-site-config", "Docs Site Config", "Real config."),
