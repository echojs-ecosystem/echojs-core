...
export const docTocMobileStyles = tv({
  slots: {
    ...
    toggleLabel:
      'text-[11px] font-bold uppercase tracking-[0.14em] text-fg-subtle',
    toggleChevron: 'text-xs text-fg-subtle transition-transform duration-200',
    toggleChevronOpen: 'rotate-180',
    panel:
      'mt-3 rounded-2xl border border-border/80 bg-surface-elevated/60 p-4 dark:border-white/10 dark:bg-surface-elevated/40',
    ...
    linkActive: 'font-medium text-echo-600 dark:text-echo-400',
