...
export const shellStyles = tv({
  slots: {
    ...
    sidebarResources:
      'mt-2 flex flex-col gap-0.5 border-t border-border/70 pt-4 dark:border-white/10',
    packageGroup: 'mb-0.5',
    ...
    packageChildren:
      'mb-2 ml-3 flex flex-col gap-0.5 border-l border-border/70 pl-2 dark:border-white/10',
    packageChildWrap: 'min-w-0',
    packageNavIconSlot:
      'inline-flex h-4 w-4 shrink-0 items-center justify-center',
    packageNavLabel: 'min-w-0 flex-1 truncate text-left',
    packageNavChevronSlot:
    ...
    sectionTitleIcon:
      'inline-flex h-3.5 w-3.5 shrink-0 text-echo-600/80 dark:text-echo-400/80',
