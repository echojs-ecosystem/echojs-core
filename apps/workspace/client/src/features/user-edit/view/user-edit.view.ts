...
import { USER_EDIT_COUNTRIES, USER_EDIT_TAGS } from '../model/user-edit.constants'
      ...
      div({ class: 'mt-6 grid gap-4 sm:grid-cols-2' }, [
        ...
        div({ class: 'grid gap-1' }, [
          ...
          select({ class: layout.select(), ...bindField(fields.country) }, [
            ...USER_EDIT_COUNTRIES.map((country) => option({ value: country }, country)),
          ]),
        ]),
