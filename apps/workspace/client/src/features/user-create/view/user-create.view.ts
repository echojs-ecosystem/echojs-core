...
import { USER_CREATE_COUNTRIES, USER_CREATE_TAGS } from '../model/user-create.constants'
      ...
      div({ class: 'mt-6 grid gap-4 sm:grid-cols-2' }, [
        ...
        div({ class: 'grid gap-1' }, [
          ...
          select({ class: layout.select(), ...bindField(fields.country) }, [
            ...USER_CREATE_COUNTRIES.map((country) => option({ value: country }, country)),
          ]),
        ]),
