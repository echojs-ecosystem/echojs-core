...
export const meetHtmlStatusEnum = {
    FOUND: "FOUND",
    PREPARING: "PREPARING",
...
export type MeetHtmlStatusEnumKey = (typeof meetHtmlStatusEnum)[keyof typeof meetHtmlStatusEnum];

export type MeetHtml = {
    /**
    ...
    */
     ...
     * @type string,null
    */
    status?: MeetHtmlStatusEnumKey | null;
    /**
     * @type string,null, iri-reference
    */
    user?: string | null;
